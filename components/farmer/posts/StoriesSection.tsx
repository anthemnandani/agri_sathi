      ...
      <div className="flex items-center gap-4 overflow-x-auto pb-2 scrollbar-hide">
        {stories.map((story) => (
          <div key={story.id} className="flex flex-col items-center gap-2 cursor-pointer flex-shrink-0">
            <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-green-400 to-green-600 p-0.5 flex items-center justify-center text-2xl hover:shadow-lg transition-shadow">
              {story.image}
            </div>
